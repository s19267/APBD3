...
namespace WebApplication.Controllers
{
    ...
    public class EnrollmentsController : ControllerBase
    {
        ...
        {
            using (SqlConnection con = new SqlConnection("Data Source=db-mssql;Initial Catalog=s19267;Integrated Security=True"))
            using (SqlCommand com = new SqlCommand())
            {
                ...
                tran.Commit();
                return CreatedAtAction("createStudent", new EnrollmentResponse{IdEnrollment = idEnrollment,IdStudy = idStudyEnrollment,Semester =semesterEnrollment,StartDate = startDateEnrollment});
